...
{ 
	...
	input_file>>v>>a;
  	...
  	//myfile.open ("required_output_graph.txt");
  	
  	

  	//change this n value to whatever you want to;
  	int n=26;
	...
	int begin,end;
	cout<<"Enter value of start node>>\n";
	cin>>begin;
	cout<<"Enter value of end node>>\n";
	cin>>end;
	minCut(graph2, begin, end); 
